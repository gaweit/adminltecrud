        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if (isset($_GET['page']) && $_GET['page'] == "data_pembelian") {
                                echo "active";
                              } ?>">
                    ...
                    <li class="treeview <?php if (isset($_GET['page']) && $_GET['page'] == "data_teknisi") {
                                echo "active";
                              } ?>">
                    ...
                    <li class="treeview <?php if (isset($_GET['page']) && $_GET['page'] == "spk") {
                                echo "active";
                              } ?>">
                        <a href="./?page=spk">
                    ...
                    <li class="<?php if (isset($_GET['page']) && $_GET['page'] == "admin") {
                          echo "active";
                        } ?>">
                        <a href="./?page=admin"><i class="fa fa-user text-warning"></i> Managemen User</a>
                    </li>
                    <li class="treeview">
                        <a href="logout.php">
