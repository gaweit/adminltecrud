  ...
  $(document).ready(function() {
    ...
    var bar_data = {
      data: [
        ...
        ["Data Pembelian", <?php echo mysql_num_rows($data_pembelian); ?>],
        ["Data Teknisi", <?php echo mysql_num_rows($data_teknisi); ?>],
        ["Data SPK", <?php echo mysql_num_rows($data_spk); ?>]
      ],
      color: "#00A3CB"
    };
    ...
    var donutData = [{
        label: "Data User",
        data: <?php echo mysql_num_rows($data_user); ?>,
        color: "#00C0EF"
      },
      {
        label: "Data Pembelian",
        data: <?php echo mysql_num_rows($data_pembelian); ?>,
        color: "#00A65A"
      },
      {
        label: "Data Teknisi",
        data: <?php echo mysql_num_rows($data_teknisi); ?>,
        color: "#F39C12"
      },
      {
        label: "Data SPK",
        data: <?php echo mysql_num_rows($data_spk); ?>,
        color: "#DD4B39"
      }
    ];
